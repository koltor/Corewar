...
/*   Updated: 2019/10/14 10:30:28 by matheme     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void		indirect_load(t_process *process, t_data *arena_data, int verbose)
{
	...
	process->reg[r1 - 1] = arena_data->arena[((process->pc + params1 + params2) % IDX_MOD) % MEM_SIZE] & 0x000000ff;
